...
#import "JianCeYuJinTJViewController.h"
#import "VTMagic.h"
#import "JianCeYuJinTJSonViewController.h"

@interface JianCeYuJinTJViewController ()<VTMagicViewDataSource,VTMagicViewDelegate>
{
...
@implementation JianCeYuJinTJViewController
...
- (UIViewController *)magicView:(VTMagicView *)magicView viewControllerAtPage:(NSUInteger)pageIndex {
    static NSString *gridId = @"JianCeYuJinTJSonViewController";
    JianCeYuJinTJSonViewController *viewController = [magicView dequeueReusablePageWithIdentifier:gridId];
    if (!viewController) {
        viewController = [[JianCeYuJinTJSonViewController alloc] init];
    }
