...
#import "PHZhiTJViewController.h"
#import "VTMagic.h"
#import "PHZhiTJSonViewController.h"


@interface PHZhiTJViewController ()<VTMagicViewDataSource,VTMagicViewDelegate>
{
...
@implementation PHZhiTJViewController
...
- (UIViewController *)magicView:(VTMagicView *)magicView viewControllerAtPage:(NSUInteger)pageIndex {
    static NSString *gridId = @"PHZhiTJSonViewController";
    PHZhiTJSonViewController *viewController = [magicView dequeueReusablePageWithIdentifier:gridId];
    if (!viewController) {
        viewController = [[PHZhiTJSonViewController alloc] init];
    }
