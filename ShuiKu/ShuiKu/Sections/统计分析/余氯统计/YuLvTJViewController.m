...
#import "YuLvTJViewController.h"
#import "VTMagic.h"
#import "YuLvTJVSonViewController.h"

@interface YuLvTJViewController ()<VTMagicViewDataSource,VTMagicViewDelegate>
{
...
@implementation YuLvTJViewController
...
- (UIViewController *)magicView:(VTMagicView *)magicView viewControllerAtPage:(NSUInteger)pageIndex {
    static NSString *gridId = @"YuLvTJVSonViewController";
    YuLvTJVSonViewController *viewController = [magicView dequeueReusablePageWithIdentifier:gridId];
    if (!viewController) {
        viewController = [[YuLvTJVSonViewController alloc] init];
    }
