...
#import "ZhuoDuTJViewController.h"
#import "VTMagic.h"
#import "ZhuoDuTJSonViewController.h"

@interface ZhuoDuTJViewController ()<VTMagicViewDataSource,VTMagicViewDelegate>
{
...
@implementation ZhuoDuTJViewController
...
- (UIViewController *)magicView:(VTMagicView *)magicView viewControllerAtPage:(NSUInteger)pageIndex {
    static NSString *gridId = @"ZhuoDuTJSonViewController";
    ZhuoDuTJSonViewController *viewController = [magicView dequeueReusablePageWithIdentifier:gridId];
    if (!viewController) {
        viewController = [[ZhuoDuTJSonViewController alloc] init];
    }
