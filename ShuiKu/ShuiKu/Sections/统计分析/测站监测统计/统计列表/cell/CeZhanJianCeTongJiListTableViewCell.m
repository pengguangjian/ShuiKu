//
//  CeZhanJianCeTongJiListTableViewCell.m
//  ShuiKu
//
...
@interface CeZhanJianCeTongJiListTableViewCell ()
@property (nonatomic , strong) NSMutableArray *arrallLB;
@end
@implementation CeZhanJianCeTongJiListTableViewCell
...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if(self = [super initWithStyle:style reuseIdentifier:reuseIdentifier])
    {
        ...
        float fitemw = (kMainScreenW-84)/7;
        for(int i = 0; i < 7; i++)
        {
