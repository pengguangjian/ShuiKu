//
//  CeZhanJianCeTongJiViewController.m
//  ShuiKu
//
...
@interface CeZhanJianCeTongJiViewController ()<VTMagicViewDataSource,VTMagicViewDelegate>
{
...
@implementation CeZhanJianCeTongJiViewController
...
- (UIViewController *)magicView:(VTMagicView *)magicView viewControllerAtPage:(NSUInteger)pageIndex {
    static NSString *gridId = @"CeZhanJianCeTJViewController";
    CeZhanJianCeTJViewController *viewController = [magicView dequeueReusablePageWithIdentifier:gridId];
    if (!viewController) {
        viewController = [[CeZhanJianCeTJViewController alloc] init];
    }
