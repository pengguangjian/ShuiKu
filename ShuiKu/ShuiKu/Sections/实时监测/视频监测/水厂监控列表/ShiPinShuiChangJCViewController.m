//
//  ShiPinShuiChangJCViewController.m
//  ShuiKu
//
...
@implementation ShiPinShuiChangJCViewController
...
{
    static NSString *strcell = @"ShiPinShuiChangJCTableViewCell";
    ShiPinShuiChangJCTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:strcell];
    if(!cell)
    {
