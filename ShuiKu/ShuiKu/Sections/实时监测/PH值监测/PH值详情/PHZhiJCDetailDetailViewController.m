//
//  PHZhiJCDetailDetailViewController.m
//  ShuiKu
//
...
#import "PHZhiJCDetailDetailTableViewCell.h"
#import "LiuLiangJCDataController.h"

@interface PHZhiJCDetailDetailViewController ()<UITextFieldDelegate,UITableViewDelegate,UITableViewDataSource,TimeClectAlterViewDelegate>
...
@implementation PHZhiJCDetailDetailViewController
- (void)viewDidLoad {
    [super viewDidLoad];
...
{
    static NSString *strcell = @"PHZhiJCDetailDetailTableViewCell";
    PHZhiJCDetailDetailTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:strcell];
    if(!cell)
    {
        cell = [[PHZhiJCDetailDetailTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:strcell];
