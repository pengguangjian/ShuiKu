...
@implementation WenDuJCViewController
...
{
    static NSString *strcell = @"WenDuJCTableViewCell";
    WenDuJCTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:strcell];
    if(!cell)
    {
        cell = [[WenDuJCTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:strcell];
    }
