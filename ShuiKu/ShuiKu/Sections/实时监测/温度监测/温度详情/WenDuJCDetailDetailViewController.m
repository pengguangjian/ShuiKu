...
//
//  WenDuJCDetailDetailViewController.m
//  ShuiKu
//
...
@interface WenDuJCDetailDetailViewController ()<UITextFieldDelegate,UITableViewDelegate,UITableViewDataSource>

@property (nonatomic , strong) UITableView *tabview;

@end

@implementation WenDuJCDetailDetailViewController
...
{
    static NSString *strcell = @"WenDuJCDetailDetailTableViewCell";
    WenDuJCDetailDetailTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:strcell];
    if(!cell)
    {
        cell = [[WenDuJCDetailDetailTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:strcell];
