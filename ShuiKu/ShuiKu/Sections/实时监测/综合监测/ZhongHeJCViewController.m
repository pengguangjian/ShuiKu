...
@implementation ZhongHeJCViewController
...
{
    static NSString *strcell = @"ZhongHeJCTableViewCell";
    ZhongHeJCTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:strcell];
    if(!cell)
    {
