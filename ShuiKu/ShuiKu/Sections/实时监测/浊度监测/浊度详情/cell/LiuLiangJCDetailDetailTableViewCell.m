...
//
//  LiuLiangJCDetailDetailTableViewCell.m
//  ShuiKu
//
...
@interface LiuLiangJCDetailDetailTableViewCell ()
...
@implementation LiuLiangJCDetailDetailTableViewCell
...
-(void)setModel:(JianCeMainListModel *)model
{
    ...
    [lb0 setText:[NSString stringWithFormat:@"%@ NTU", model.TURB0]];
    
    UILabel *lb1 = self.arrallLB[1];
    [lb1 setText:[NSString stringWithFormat:@"%@ NTU", model.TURB1]];
