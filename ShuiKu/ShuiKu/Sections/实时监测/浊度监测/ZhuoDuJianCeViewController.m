...
{
    static NSString *strcell = @"ZhuoDuJianCeTableViewCell";
    ZhuoDuJianCeTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:strcell];
    if(!cell)
    {
