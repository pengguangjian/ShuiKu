...
#import "YuLvYJViewController.h"
#import "YuLvYJTableViewCell.h"
@interface YuLvYJViewController ()<UITextFieldDelegate,UITableViewDelegate,UITableViewDataSource>

@property (nonatomic , strong) UITableView *tabview;

@end

@implementation YuLvYJViewController
...
{
    static NSString *strcell = @"YuLvYJTableViewCell";
    YuLvYJTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:strcell];
    if(!cell)
    {
        cell = [[YuLvYJTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:strcell];
    }
