...
#import "PHZhiYJViewController.h"
#import "PHZhiYJTableViewCell.h"
@interface PHZhiYJViewController ()<UITextFieldDelegate,UITableViewDelegate,UITableViewDataSource>

@property (nonatomic , strong) UITableView *tabview;

@end

@implementation PHZhiYJViewController
...
{
    static NSString *strcell = @"PHZhiYJTableViewCell";
    PHZhiYJTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:strcell];
    if(!cell)
    {
        cell = [[PHZhiYJTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:strcell];
    }
