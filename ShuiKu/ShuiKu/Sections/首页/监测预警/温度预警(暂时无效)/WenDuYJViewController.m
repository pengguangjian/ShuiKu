...
#import "WenDuYJViewController.h"
#import "WenDuYJTableViewCell.h"
@interface WenDuYJViewController ()<UITextFieldDelegate,UITableViewDelegate,UITableViewDataSource>

@property (nonatomic , strong) UITableView *tabview;

@end

@implementation WenDuYJViewController
...
{
    static NSString *strcell = @"WenDuYJTableViewCell";
    WenDuYJTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:strcell];
    if(!cell)
    {
        cell = [[WenDuYJTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:strcell];
    }
