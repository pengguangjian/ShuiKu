...
@interface ZhiShiKuListTableViewCell ()
...
-(void)layoutSubviews
{
    ...
    [_lbname setText:[NSString nullToString:[self.dicvalue objectForKey:@"KBTITLE"]]];
    
    [_lbcontent setText:[NSString nullToString:[self.dicvalue objectForKey:@"KBSUMMARY"]]];
