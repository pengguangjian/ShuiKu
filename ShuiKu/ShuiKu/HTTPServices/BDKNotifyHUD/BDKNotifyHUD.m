...
#define kBDKNotifyHUDDefaultRoundness    4.0f
#define kBDKNotifyHUDDefaultOpacity      0.6f
#define kBDKNotifyHUDDefaultPadding      10.0f
#define kBDKNotifyHUDDefaultInnerPadding 8.0f
...
- (void)adjustTextLabel:(UILabel *)label {
    ...
    frame.size.width = self.backgroundView.frame.size.width-(kBDKNotifyHUDDefaultInnerPadding);
